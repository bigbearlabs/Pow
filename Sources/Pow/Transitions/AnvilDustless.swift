...
public extension AnyTransition.MovingParts {
    ...
    static var anvilDustless: AnyTransition {
        .asymmetric(
            insertion: .modifier(
                active:   AnvilDustless(animatableData: 0),
                identity: AnvilDustless(animatableData: 1)
            ),
            removal: .identity
        )
...
internal struct AnvilDustless: ViewModifier, ProgressableAnimation, AnimatableModifier {
...
#if os(iOS) && DEBUG
struct AnvilDustless_Preview: PreviewableAnimation, PreviewProvider {
  static var animation: AnvilDustless {
    AnvilDustless(animatableData: 0)
  }
...
@available(iOS 15.0, *)
struct AnvilDustless_Previews: PreviewProvider {
